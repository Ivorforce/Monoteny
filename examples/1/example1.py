...
def main():
    ...
    """
    print("Test: ")
    a = (square_0(float32(2.2), Number=mn.declarations.Number_10)) * (float32(np.e))
    b = (square_0(float32(5), Number=mn.declarations.Number_10)) + (pi_ish_0(Float=mn.declarations.Float_0))
    b = floor_div((square_0(b, Number=mn.declarations.Number_10)) ** (-(float32(2.2))), math.log(a, float32(np.pi * 2)), Float=mn.declarations.Float_0)
